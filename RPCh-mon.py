...
while True:
    ...
    plt.savefig("/mnt/latencies-all.png", bbox_inches='tight')

    plt.figure(1)
    plt.figure(1).clear()
    newHist()
    plt.hist(dfAllGotResponse["latency"], bins=logbins, color="blue", orientation="horizontal")
    plt.savefig("/mnt/hist-lat-all.png", bbox_inches='tight')
    ...
    plt.legend(loc="upper left")
    plt.savefig("/mnt/latencies-24h.png", bbox_inches='tight')

    plt.figure(3)
    plt.figure(3).clear()
    newHist()
    plt.hist(df24hGotResponse["latency"], bins=logbins, color="blue", orientation="horizontal")
    plt.savefig("/mnt/hist-lat-24h.png", bbox_inches='tight')
    ...
    plt.legend(loc="upper left")
    plt.savefig("/mnt/latencies-1h.png", bbox_inches='tight')

    plt.figure(5)
    plt.figure(5).clear()
    newHist()
    plt.hist(df1hGotResponse["latency"], bins=logbins, color="blue", orientation="horizontal")
    plt.savefig("/mnt/hist-lat-1h.png", bbox_inches='tight')
